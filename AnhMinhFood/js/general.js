jQuery(document).ready(function() {
    ...
    function init() {
        var myLatLong = new google.maps.LatLng(10.7868727 ,106.6355210);  // Set coordinates for map
        ...
        var marker = new google.maps.Marker({                                       // Create and set the marker
            position: myLatLong,
            map: map,
            title: 'ANH MINH FOOD COMPANY LIMITED',
            popup: true,
            icon: image_marker
        });
        var contentString =  '<div class="map-popup-info-wrap"><strong>AnhMinhFood Company Limited</strong><br><span>' +   // Create html content for popup info
            '251/5 VƯỜN LÀI, P AN PHÚ ĐÔNG, QUẬN 12 ' +
            '<br>Tel.: (+84)089.66.99.289 </span></div>';
